...
import { AboutComponent, ContactComponent, JuridischAdviesComponent, MenuFooterComponent, MenuMainComponent, MenuMobileComponent, PartnerschapComponent, PrivacyComponent } from './elements.component';
...
let appRoutes: Routes = [
  ...
  { path: 'legal-advice', component: JuridischAdviesComponent },
  { path: 'kb', component:PartnerschapComponent },
...
@NgModule({
  declarations: [ AppComponent,
                  HomeComponent,
                  AboutComponent, ContactComponent, JuridischAdviesComponent, MenuFooterComponent, MenuMainComponent, MenuMobileComponent, PartnerschapComponent, PrivacyComponent, 
